...
public:
    ...
    Shader(const char* computePath) {
        ...
        catch (std::ifstream::failure& e)
        {
            ...
            std::cout << "Current Compute Shader's PATH: " << computePath << std::endl;
        }
    ...
    Shader(const char* vertexPath, const char* fragmentPath, bool tess, const char* geometryPath = nullptr,
