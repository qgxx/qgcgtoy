...
int IBL::initialize() {
    ...
    // -------------------------
    pbrShader = new Shader("assets/shaders/GLSL/pbr_vert.glsl", "assets/shaders/GLSL/pbr_ibl_frag.glsl");
    ...
    if (!captureFBO) return -1;
    if (!captureRBO) return -1;
