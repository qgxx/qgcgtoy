				...
				.load(name + '.obj', function (object) {
					object.traverse(function (child) {
						if (child.isMesh) {
							...
							switch (objMaterial) {
								case 'PhongMaterial':
									material = buildPhongMaterial(colorMap, mat.specular.toArray(), light, Translation, Scale, "./webgl/shaders/phongVertex.glsl", "./webgl/shaders/phongFragment.glsl");
									shadowMaterial = buildShadowMaterial(light, Translation, Scale, "./webgl/shaders/shadowVertex.glsl", "./webgl/shaders/shadowFragment.glsl");
									break;
								// TODO: Add your PRTmaterial here

								case 'PRTMaterial':
									material = buildPRTMaterial("./webgl/shaders/prtVertex.glsl", "./webgl/shaders/prtFragment.glsl");
									break;

								case 'SkyBoxMaterial':
									material = buildSkyBoxMaterial("./webgl/shaders/SkyBoxVertex.glsl", "./webgl/shaders/SkyBoxFragment.glsl");
									break;
							}
